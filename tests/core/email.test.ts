...
import type { EmailProvider, EmailBody } from "../../core/types.js";
import { sendEmail, type EmailConfig } from "../../core/email.js";
...
describe("sendEmail", () => {
  it("calls provider with sanitized payload", async () => {
